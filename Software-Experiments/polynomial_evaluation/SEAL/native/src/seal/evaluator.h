    ...
    */
    ...
    public:
        ...
        */
        inline void relinearize_inplace(
            Ciphertext &encrypted, const RelinKeys &relin_keys, double err_bit, double err_ind, int flag,MemoryPoolHandle pool = MemoryManager::GetPool())
        {
                //std::cout << "here in relinearize" << std::endl;
		relinearize_internal(encrypted, relin_keys, 2,err_bit,err_ind,flag, std::move(pool));
        }
        ...
        */
        inline void relinearize(
            const Ciphertext &encrypted, const RelinKeys &relin_keys, Ciphertext &destination,double err_bit, double err_ind, int flag,
            MemoryPoolHandle pool = MemoryManager::GetPool())
        {
            destination = encrypted;
            relinearize_inplace(destination, relin_keys,err_bit,err_ind,flag, std::move(pool));
        }
        ...
        */
        void rescale_to_next(
            const Ciphertext &encrypted, Ciphertext &destination, double err_bit, double err_ind, int flag,MemoryPoolHandle pool = MemoryManager::GetPool());
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        inline void rescale_to_next_inplace(Ciphertext &encrypted, double err_bit, double err_ind, int flag,MemoryPoolHandle pool = MemoryManager::GetPool())
        {
            rescale_to_next(encrypted, encrypted, err_bit,err_ind,flag,std::move(pool));
        }
    ...
    private:
        ...
        void relinearize_internal(
            Ciphertext &encrypted, const RelinKeys &relin_keys, std::size_t destination_size,double err_bit, double err_ind, int flag, MemoryPoolHandle pool);

        void mod_switch_scale_to_next(const Ciphertext &encrypted, Ciphertext &destination, double err_bit, double err_ind, int flag,MemoryPoolHandle pool);
        ...
        void switch_key_inplace(
            ...
            std::size_t key_index, double err_bit, double err_ind, int flag, MemoryPoolHandle pool = MemoryManager::GetPool());
