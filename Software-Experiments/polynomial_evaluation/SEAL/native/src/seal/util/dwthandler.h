    ...
    namespace util
    {
        ...
        */
        ...
        public:
            ...
            RootType mul_root_scalar(const RootType &r, const ScalarType &s, int flag) const;
        ...
        public:
            ...
            */
                ...
                ValueType *values, int log_n, const RootType *roots, const ScalarType *scalar = nullptr) const
            {
                ...
                if (scalar != nullptr)
                {
                    ...
                    {
                        r = *++roots;
                        scaled_r = arithmetic_.mul_root_scalar(r, *scalar,0);
            ...
            */
            void transform_from_rev(
                ValueType *values, int log_n, const RootType *roots, const ScalarType *scalar = nullptr,int flag=0) const
            {
            //std::cout << "here in transform_from_rev" << std::endl;
               ...
               // constant transform size
                ...
                if (scalar != nullptr)
                {
                    ...
                    if (flag == 1){
                     ...
                     std::cout << "before mul_root in dwthandler (flag = 1)" << std::endl;
                    }
                    RootType scaled_r = arithmetic_.mul_root_scalar(r, *scalar,flag);
                    x = values;
                    y = x + gap;
                    if (gap < 4)
                    {
