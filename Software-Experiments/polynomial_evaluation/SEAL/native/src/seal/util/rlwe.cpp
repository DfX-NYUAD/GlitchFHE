    ...
    namespace util
    {
            ...
            Ciphertext &destination)
        {
            ...
            for (size_t i = 0; i < coeff_modulus_size; i++)
            {
                ...
                for (size_t j = 0; j < encrypted_size; j++)
                {
                    ...
                    if (!is_ntt_form)
                    {
                        inverse_ntt_negacyclic_harvey(destination.data(j) + i * coeff_count, ntt_tables[i],0);
                    }
                }
            }
            ...
            bool save_seed, Ciphertext &destination)
        {
            ...
            for (size_t i = 0; i < coeff_modulus_size; i++)
            {
                ...
                {
                    inverse_ntt_negacyclic_harvey(c0 + i * coeff_count, ntt_tables[i],0);
                }
                add_poly_coeffmod(
            ...
            if (!is_ntt_form && !save_seed)
            {
                for (size_t i = 0; i < coeff_modulus_size; i++)
                {
                    ...
                    inverse_ntt_negacyclic_harvey(c1 + i * coeff_count, ntt_tables[i],0);
                }
            }
