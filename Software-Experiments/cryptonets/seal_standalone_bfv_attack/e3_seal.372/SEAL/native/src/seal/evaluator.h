    ...
    */
    ...
    public:
        ...
        */
        inline void relinearize_inplace(
            Ciphertext &encrypted, const RelinKeys &relin_keys,  double err_ind, int flag, MemoryPoolHandle pool = MemoryManager::GetPool()) const
        {
            relinearize_internal(encrypted, relin_keys, 2, err_ind, flag, std::move(pool));
        }
        ...
        */
        inline void relinearize(
            const Ciphertext &encrypted, const RelinKeys &relin_keys, Ciphertext &destination, double err_ind, int flag,
            MemoryPoolHandle pool = MemoryManager::GetPool()) const
        {
            destination = encrypted;
            relinearize_inplace(destination, relin_keys, err_ind, flag, std::move(pool));
        }
        ...
        */
        void rescale_to_next(
            const Ciphertext &encrypted, Ciphertext &destination, double err_bit, double err_ind, int flag,
            MemoryPoolHandle pool = MemoryManager::GetPool()) const;
        ...
        */
        inline void rescale_to_next_inplace(
            Ciphertext &encrypted,double err_bit, double err_ind, int flag, MemoryPoolHandle pool = MemoryManager::GetPool()) const
        {
    ...
    private:
        ...
        void relinearize_internal(
            Ciphertext &encrypted, const RelinKeys &relin_keys, std::size_t destination_size, double err_ind, int flag,
        ...
        void switch_key_inplace(
            ...
            std::size_t key_index, double err_ind, int flag, MemoryPoolHandle pool = MemoryManager::GetPool()) const;
