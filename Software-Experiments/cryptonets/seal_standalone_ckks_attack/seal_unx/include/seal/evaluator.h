    ...
    */
    ...
    public:
        ...
        */
        ...
        {
            destination = encrypted;
//	    std::cout << "in add_plain" << std::endl;
    ...
    private:
        ...
        void relinearize_internal(
            Ciphertext &encrypted, const RelinKeys &relin_keys, std::size_t destination_size,double err_ind, int flag,            MemoryPoolHandle pool) const;
